...
1. Download [https://storage.googleapis.com/lotus-project/lotus-1.0.2-win64-setup-unsigned.exe](https://storage.googleapis.com/lotus-project/lotus-1.0.2-win64-setup-unsigned.exe) and install it somewhere convenient. It'll create shortcuts in your start menu.
